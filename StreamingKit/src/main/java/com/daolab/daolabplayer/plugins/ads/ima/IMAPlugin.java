...
package com.daolab.daolabplayer.plugins.ads.ima;
...
import com.daolab.daolabplayer.plugins.ads.AdInfo;
import com.daolab.daolabplayer.plugins.ads.AdsProvider;
...
import com.daolab.daolabplayer.ads.AdTagType;
import com.daolab.daolabplayer.ads.DLAdProviderListener;
import com.daolab.daolabplayer.plugins.ads.AdEvent;
import com.daolab.daolabplayer.ads.DLAdErrorType;
...
import static com.daolab.daolabplayer.plugins.ads.AdEvent.Type.AD_BREAK_ENDED;
import static com.daolab.daolabplayer.plugins.ads.AdEvent.Type.AD_BREAK_STARTED;
import static com.daolab.daolabplayer.plugins.ads.AdEvent.Type.AD_PROGRESS;


/**
 * Created by almond on 17/11/2016.
 */
...
public class IMAPlugin extends PKPlugin implements AdsProvider, com.google.ads.interactivemedia.v3.api.AdEvent.AdEventListener, AdErrorEvent.AdErrorListener {
    ...
    private DLAdProviderListener DLAdProviderListener;
    ...
    private void requestAdsFromIMA(String adTagUrl) {
        ...
        if (TextUtils.isEmpty(adTagUrl)) return;
    ...
    public void setAdProviderListener(AdEnabledPlayerController adEnabledPlayerController) {
        DLAdProviderListener = adEnabledPlayerController;
    }

    @Override
    public void removeAdProviderListener() {
        DLAdProviderListener = null;
    }
        ...
        switch (lastEventReceived) {
            ...
            case CONTENT_RESUME_REQUESTED:
                ...
                if (!isContentPrepared) {
                    ...
                    if (DLAdProviderListener != null && !appIsInBackground) {
                        preparePlayer(true);
                    }
                } else if (player != null) {
            ...
            case LOG:
                ...
                sendError(DLAdErrorType.QUIET_LOG_ERROR, error, null);
                break;
            default:
                break;
        }
    ...
    private void preparePlayer(boolean doPlay) {
        ...
        if (DLAdProviderListener != null && !appIsInBackground) {
            ...
            DLAdProviderListener.onAdLoadingFinished();
            if (doPlay) {
    ...
    public void onAdError(AdErrorEvent adErrorEvent) {
        ...
        Enum errorType = DLAdErrorType.UNKNOWN_ERROR;

        if (cause != null) {

            switch (cause.getErrorCode()) {
                case INTERNAL_ERROR:
                    errorType = DLAdErrorType.INTERNAL_ERROR;
                    break;
                case VAST_MALFORMED_RESPONSE:
                    errorType = DLAdErrorType.VAST_MALFORMED_RESPONSE;
                    break;
                case UNKNOWN_AD_RESPONSE:
                    errorType = DLAdErrorType.UNKNOWN_AD_RESPONSE;
                    break;
                case VAST_LOAD_TIMEOUT:
                    errorType = DLAdErrorType.VAST_LOAD_TIMEOUT;
                    break;
                case VAST_TOO_MANY_REDIRECTS:
                    errorType = DLAdErrorType.VAST_TOO_MANY_REDIRECTS;
                    break;
                case VIDEO_PLAY_ERROR:
                    errorType = DLAdErrorType.VIDEO_PLAY_ERROR;
                    break;
                case VAST_MEDIA_LOAD_TIMEOUT:
                    errorType = DLAdErrorType.VAST_MEDIA_LOAD_TIMEOUT;
                    break;
                case VAST_LINEAR_ASSET_MISMATCH:
                    errorType = DLAdErrorType.VAST_LINEAR_ASSET_MISMATCH;
                    break;
                case OVERLAY_AD_PLAYING_FAILED:
                    errorType = DLAdErrorType.OVERLAY_AD_PLAYING_FAILED;
                    break;
                case OVERLAY_AD_LOADING_FAILED:
                    errorType = DLAdErrorType.OVERLAY_AD_LOADING_FAILED;
                    break;
                case VAST_NONLINEAR_ASSET_MISMATCH:
                    errorType = DLAdErrorType.VAST_NONLINEAR_ASSET_MISMATCH;
                    break;
                case COMPANION_AD_LOADING_FAILED:
                    errorType = DLAdErrorType.COMPANION_AD_LOADING_FAILED;
                    break;
                case UNKNOWN_ERROR:
                    errorType = DLAdErrorType.UNKNOWN_ERROR;
                    break;
                case VAST_EMPTY_RESPONSE:
                    errorType = DLAdErrorType.VAST_EMPTY_RESPONSE;
                    break;
                case FAILED_TO_REQUEST_ADS:
                    errorType = DLAdErrorType.FAILED_TO_REQUEST_ADS;
                    break;
                case VAST_ASSET_NOT_FOUND:
                    errorType = DLAdErrorType.VAST_ASSET_NOT_FOUND;
                    break;
                case ADS_REQUEST_NETWORK_ERROR:
                    errorType = DLAdErrorType.ADS_REQUEST_NETWORK_ERROR;
                    break;
                case INVALID_ARGUMENTS:
                    errorType = DLAdErrorType.INVALID_ARGUMENTS;
                    break;
                case PLAYLIST_NO_CONTENT_TRACKING:
                    errorType = DLAdErrorType.PLAYLIST_NO_CONTENT_TRACKING;
                    break;
            }
        }
