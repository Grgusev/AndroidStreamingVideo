...
import com.daolab.daolabplayer.drm.DeferredDrmSessionManager;
import com.daolab.daolabplayer.player.metadata.MetadataConverter;
import com.daolab.daolabplayer.player.metadata.PKMetadata;
import com.daolab.daolabplayer.utils.Consts;
import com.daolab.daolabplayer.utils.EventLogger;
...
import com.daolab.daolabmedia.DaolabHttpDataSourceFactory;

/**
 * Created by almond on 31/10/2016.
 */
class ExoPlayerWrapper implements PlayerEngine, ExoPlayer.EventListener, MetadataRenderer.Output, BandwidthMeter.EventListener {
    ...
    private HttpDataSource.Factory buildHttpDataSourceFactory(boolean useBandwidthMeter) {
        return new DaolabHttpDataSourceFactory(getUserAgent(context), useBandwidthMeter ? bandwidthMeter : null, DefaultHttpDataSource.DEFAULT_CONNECT_TIMEOUT_MILLIS,
    ...
    public void setEventListener(final PlayerController.EventListener eventTrigger) {
