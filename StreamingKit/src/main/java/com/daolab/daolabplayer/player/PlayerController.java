...
import com.daolab.daolabplayer.Assert;
import com.daolab.daolabplayer.PKLog;
import com.daolab.daolabplayer.PlayerEvent;
import com.daolab.daolabplayer.ads.AdController;
...
import static com.daolab.daolabplayer.PKMediaFormat.wvm;
                ...
                switch (eventType) {
                    case DURATION_CHANGE:
                        ...
                        if (getDuration() != Consts.TIME_UNSET && isNewEntry) {
                            startPlaybackFrom(mediaConfig.getStartPosition() * Consts.MILLISECONDS_MULTIPLIER);
                            isNewEntry = false;
                        }
                        break;
