...
public class BasePlaybackSource extends BaseResult {
    ...
    protected List<DaolabDrmPlaybackPluginData> drm;


    public List<DaolabDrmPlaybackPluginData> getDrmData() {
        return drm;
    }
    ...
    public String getDrmSchemes(){
        ...
        if(hasDrmData()){
            for (DaolabDrmPlaybackPluginData drmPlaybackPluginData : drm){
