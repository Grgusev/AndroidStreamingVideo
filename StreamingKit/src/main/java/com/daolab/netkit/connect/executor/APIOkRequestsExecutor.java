...
import com.daolab.netkit.connect.request.ExecutedRequest;
import com.daolab.netkit.connect.request.RequestConfiguration;
...
public class APIOkRequestsExecutor implements RequestQueue {
    ...
    private IdFactory idFactory = new com.daolab.netkit.connect.request.RequestIdFactory(); // default
